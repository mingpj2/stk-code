...
namespace MeshShader
{
    ...
    void RSMShader::setUniforms(const core::matrix4 &ModelMatrix, unsigned TU_tex)
    {
        glUniformMatrix4fv(uniform_MM, 1, GL_FALSE, ModelMatrix.pointer());
        glUniform1i(uniform_tex, TU_tex);
    }
...
namespace FullScreenShader
{
    ...
    GLuint RadianceHintsConstructionShader::uniform_slice;
    ...
    void RadianceHintsConstructionShader::setUniforms(const core::vector3df &extents, unsigned slice, unsigned TU_ctex, unsigned TU_ntex, unsigned TU_dtex)
    {
    ...
    void GlobalIlluminationReconstructionShader::setUniforms(const core::vector3df &extents, unsigned TU_ntex, unsigned TU_dtex, unsigned TU_SHR, unsigned TU_SHG, unsigned TU_SHB)
    {
        glUniform1i(uniform_ntex, TU_ntex);
        glUniform1i(uniform_dtex, TU_dtex);
        glUniform1i(uniform_SHR, TU_SHR);
